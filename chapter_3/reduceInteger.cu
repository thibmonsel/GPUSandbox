...
__global__ void reduceUnrolling2(int *g_idata, int *g_odata, unsigned int n)
{
    ...
    // unrolling 2
    /*
    Note the following statement added at the start of the kernel. Here, each thread is adding an element
    from the neighboring data block. Conceptually, you can think of this as an iteration of the reduction
    loop that reduces across data blocks
    */
    if (idx + blockDim.x < n)
